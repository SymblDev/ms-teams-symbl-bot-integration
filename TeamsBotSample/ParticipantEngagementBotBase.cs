...
namespace Microsoft.Psi.TeamsBot
{
    ...
    public abstract class ParticipantEngagementBotBase : Subpipeline, ITeamsBot
    {
        ...
        private readonly bool showRecordingMessage = false;
        ...
        /// <param name="showRecordingMessage">Show Recording Message.</param>
        public ParticipantEngagementBotBase(Pipeline pipeline, TimeSpan interval, int screenWidth, int screenHeight, bool showRecordingMessage = true)
            : base(pipeline, "ParticipantEngagementBot")
        {
            ...
            this.showRecordingMessage = showRecordingMessage;
