...
namespace Microsoft.Psi.TeamsBot
{
    ...
    public class ParticipantEngagementScaleBot : ParticipantEngagementBotBase
    {
        ...
        public ParticipantEngagementScaleBot(Pipeline pipeline, TimeSpan interval, int screenWidth, int screenHeight, bool varyHeights, bool showRecordingMessage = true)
            : base(pipeline, interval, screenWidth, screenHeight, showRecordingMessage)
        {
